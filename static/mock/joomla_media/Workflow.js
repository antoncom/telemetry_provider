 ...
 * @constructor
 */
import draw2d from './com_teamtimebpm/assets/js/draw2d/_init_.js'
draw2d.Workflow=function(/*:String*/id)
{
   try
   {
      ...
      /** @private */
      this.draggingLineCommand = null; // command for a line which will be moved via drag&drop
      ...
      // Panning ist immer an wenn es sich um ein iPad handelt. Ansonsten ist es per default aus
      //
      this.setPanning(this.isIPad); // flag for the panning feature of the workflow canvas
      ...
      if(this.html!==null)
      {
        ...
        */
        ...
        if (this.html.addEventListener)
        {
            ...
            this.html.addEventListener("touchstart", touchStart, false);
            this.html.addEventListener("touchmove", touchMove, false);
  ...
  {
     // ant pushErrorStack(e, "draw2d.Workflow=function(/*:String*/id)");
  }
};
...
draw2d.Workflow.prototype.clear=function()
{
   ...
   var tmpLines =  document.getLines().clone();
   for(var i=0;i<tmpLines.getSize();i++)
   {
     (new draw2d.CommandDelete(tmpLines.get(i))).execute();
   }

   var tmpFigures =  document.getFigures().clone();
   for(var i=0;i<tmpFigures.getSize();i++)
   {
     (new draw2d.CommandDelete(tmpFigures.get(i))).execute();
   }
 ...
 * @param {draw2d.WindowFigure} toolWindow The tool window of the canvas
 **/
draw2d.Workflow.prototype.setToolWindow=function(/*:draw2d.WindowFigure*/ toolWindow, /*:int*/x, /*:int*/y)
{
...
draw2d.Workflow.prototype.addFigure=function(/*:draw2d.Figure*/ figure ,/*:int*/ xPos, /*:int*/ yPos)
{
  ...
  {
      // ant pushErrorStack(e,"draw2d.Workflow.prototype.addFigure=function(/*:draw2d.Figure*/ figure ,/*:int*/ xPos, /*:int*/ yPos)");
  }
};
 ...
 *
 * Use <b>workflow.getDocument().getFigure(..)</b> for the
 * public access.<br>
 *
 * @private
 **/
...
/**
 * @see draw2d.WindowFigure#onSelectionChanged
 * @param {Object} w an object which implements the 'onSelectionChanged' method
 **/
draw2d.Workflow.prototype.addSelectionListener=function(/*:Object*/ w)
{
  if(w!==null)
  {
 ...
 **/
draw2d.Workflow.prototype.removeSelectionListener=function(/*:Object*/ w )
{
  this.selectionListeners.remove(w);
};

/**
 * Set the current selected figure in the workflow Canvas.<br>
 * Since version 0.9.18 you can select objects from type <b>draw2d.Figure</b> too.
 *
 * @param {draw2d.Figure} figure The new selection.
 **/
draw2d.Workflow.prototype.setCurrentSelection=function(/*:draw2d.Figure*/ figure )
{
  if(figure===null || this.currentSelection!=figure)
  {
  ...
  if(figure instanceof draw2d.Line)
  {
    ...
    if(!(figure instanceof draw2d.Connection))
    {
       this.draggingLineCommand = figure.createCommand(new draw2d.EditPolicy(draw2d.EditPolicy.MOVE));
...
/**
 * Returns the line with the given id. Use <b>workflow.getDocument().getLine(..)</b> for the
 * public access.<br>
 *
 ...
 * @since 0.9.15
 **/
draw2d.Workflow.prototype.getLine=function(/*:String*/ id)
{
  var count = this.lines.getSize();
  for(var i=0; i<count;i++)
  {
 ...
 *
 * Use <b>workflow.getDocument().getLines()</b> for the
 * public access.<br>
 *
...
/**
 * @param {draw2d.Port} p The port to remove from the workflow Canvas.
 * @private
 **/
...
draw2d.Workflow.prototype.setDocumentDirty=function()
{
  ...
  {
      // ant pushErrorStack(e,"draw2d.Workflow.prototype.setDocumentDirty=function()");
  }
};
