...
//    return parseInt(this.scrollArea.style.width);
//  else
 ...
 **/
draw2d.Canvas.prototype.setWidth=function(/*:int*/ width)
{
  if(this.scrollArea!==null)
...
{
//  if(this.scrollArea!==null)
//    return parseInt(this.scrollArea.style.height);
//  else
 ...
 * @since 0.9.18
 **/
draw2d.Canvas.prototype.setHeight=function(/*:int*/ height)
{
  if(this.scrollArea!==null)
    this.scrollArea.style.height=height+"px";
  else
...
draw2d.Canvas.prototype.setBackgroundImage=function(/*:String */ imageUrl, /*:boolean*/ repeat)
{
   ...
   {
      // ant this.html.style.background="transparent";
   }
};
