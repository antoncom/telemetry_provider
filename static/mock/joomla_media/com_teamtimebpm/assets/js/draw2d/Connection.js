 ...
 * @since 0.9.18
 **/
draw2d.Connection.prototype.setCanDrag=function(/*:boolean*/flag)
{
  this.canDrag= flag;
};
 ...
 *
 * @param {draw2d.ConnectionDecorator} the new source decorator for the connection
 **/
 ...
 * Set the ConnectionDecorator for this object.
 *
 * @param {draw2d.ConnectionDecorator} the new target decorator for the connection
 **/
 ...
 * of an connection.
 *
 * @param {draw2d.ConnectionAnchor} the new source anchor for the connection
 **/
 ...
 *
 * @param {draw2d.ConnectionAnchor} the new target anchor for the connection
 **/
...
draw2d.Connection.prototype.setWorkflow= function(/*:draw2d.Workflow*/ workflow)
{
  draw2d.Line.prototype.setWorkflow.call(this,workflow);
...
draw2d.Connection.prototype.refreshSourcePort=function()
{
   ...
   //
   var figures = this.getWorkflow().getDocument().getFigures();
