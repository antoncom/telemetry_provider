...
// "Message Event" element implementation
import draw2d from '../_init_.js'
draw2d.bpmn.Message = function () {
...
draw2d.bpmn.Message.prototype = new draw2d.bpmn.Figure();
draw2d.bpmn.Message.prototype.type = "bpmn.Message";

draw2d.bpmn.Message.prototype.createHTMLElement = function () {
	var $ = TeamTime.jQuery;
	var item = draw2d.Figure.prototype.createHTMLElement.call(this);

	$(item).html(
		'<div class="bpmn_message">\
			<div class="bpmn_icon"></div>\
			<div class="bpmn_event_content">Message</div>\
		</div>');
	$(".bpmn_icon", item).css("background-image", draw2d.bpmn.getCssImage("message.png"));

	return item;
};

draw2d.bpmn.Message.prototype.setWorkflow = function (/*:draw2d.Workflow*/ workflow) {
...
draw2d.bpmn.Message.prototype.getContentElement = function () {
	var $ = TeamTime.jQuery;
	
	return $(".bpmn_event_content", this.html);
};

draw2d.bpmn.Message.prototype.getContextMenuItems = function () {
	return {
		"delete": {
...
draw2d.bpmn.Message.prototype.onContextMenuCmd = function (data) {
	if (data.key == "delete") {
