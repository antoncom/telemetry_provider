...
// "Exception Event" element implementation
import draw2d from '../_init_.js'
draw2d.bpmn.Exception = function () {
...
draw2d.bpmn.Exception.prototype = new draw2d.bpmn.Figure();
draw2d.bpmn.Exception.prototype.type = "bpmn.Exception";

draw2d.bpmn.Exception.prototype.createHTMLElement = function() {
	var $ = TeamTime.jQuery;
	var item = draw2d.Figure.prototype.createHTMLElement.call(this);

	$(item).html(
		'<div class="bpmn_exception">\
			<div class="bpmn_icon"></div>\
			<div class="bpmn_event_content">Exception</div>\
		</div>');
	$(".bpmn_icon", item).css("background-image", draw2d.bpmn.getCssImage("exception.png"));

	return item;
};

draw2d.bpmn.Exception.prototype.setWorkflow = function (/*:draw2d.Workflow*/ workflow) {
...
draw2d.bpmn.Exception.prototype.getContentElement = function () {
	var $ = TeamTime.jQuery;

	return $(".bpmn_event_content", this.html);
};

draw2d.bpmn.Exception.prototype.getContextMenuItems = function () {
	return {
		"delete": {
...
draw2d.bpmn.Exception.prototype.onContextMenuCmd = function (data) {
	if (data.key == "delete") {
		var cmd = new draw2d.CommandDelete(data.figure);
		cmd.execute();
	}

	console.log("Exception " + data.key);
};