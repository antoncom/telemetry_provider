...
// "Condition XOR" element implementation
import draw2d from '../_init_.js'
draw2d.bpmn.ConditionXOR = function () {
...
draw2d.bpmn.ConditionXOR.prototype = new draw2d.bpmn.Figure();
draw2d.bpmn.ConditionXOR.prototype.type = "bpmn.ConditionXOR";

draw2d.bpmn.ConditionXOR.prototype.createHTMLElement = function () {
	var $ = TeamTime.jQuery;
	...
	$(item).html(
		"<div class='bpmn_condition_xor'>\
			...
			<div class='bpmn_event_content'>XOR</div>\
		</div>");
	$(".bpmn_icon", item).css("background-image", draw2d.bpmn.getCssImage("condition_xor.gif"));

	return item;
};

draw2d.bpmn.ConditionXOR.prototype.setWorkflow = function (/*:draw2d.Workflow*/ workflow) {
...
draw2d.bpmn.ConditionXOR.prototype.getContentElement = function () {
	var $ = TeamTime.jQuery;

	return $(".bpmn_event_content", this.html);
};

draw2d.bpmn.ConditionXOR.prototype.getContextMenuItems = function () {
	return {
		"delete": {
...
draw2d.bpmn.ConditionXOR.prototype.onContextMenuCmd = function (data) {
	if (data.key == "delete") {		
		var cmd = new draw2d.CommandDelete(data.figure);
		cmd.execute();
	}

	console.log("ConditionXOR " + data.key);
};