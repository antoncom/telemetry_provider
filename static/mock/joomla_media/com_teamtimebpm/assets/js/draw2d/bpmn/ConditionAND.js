...
// "Condition AND" element implementation
import draw2d from '../_init_.js'
draw2d.bpmn.ConditionAND = function () {
...
draw2d.bpmn.ConditionAND.prototype = new draw2d.bpmn.Figure();
draw2d.bpmn.ConditionAND.prototype.type = "bpmn.ConditionAND";

draw2d.bpmn.ConditionAND.prototype.createHTMLElement = function () {
	var $ = TeamTime.jQuery;
	var item = draw2d.Figure.prototype.createHTMLElement.call(this);

	$(item).html(
		"<div class='bpmn_condition_and'>\
			<div class='bpmn_icon'></div>\
			<div class='bpmn_event_content'>AND</div>\
		</div>");
	$(".bpmn_icon", item).css("background-image", draw2d.bpmn.getCssImage("condition_and.gif"));

	return item;
};

draw2d.bpmn.ConditionAND.prototype.setWorkflow = function (/*:draw2d.Workflow*/ workflow) {
...
draw2d.bpmn.ConditionAND.prototype.getContentElement = function () {
	var $ = TeamTime.jQuery;

	return $(".bpmn_event_content", this.html);
};

draw2d.bpmn.ConditionAND.prototype.getContextMenuItems = function () {
	return {
		"delete": {
...
draw2d.bpmn.ConditionAND.prototype.onContextMenuCmd = function (data) {
	if (data.key == "delete") {		
		var cmd = new draw2d.CommandDelete(data.figure);
		cmd.execute();
	}

	console.log("ConditionAND " + data.key);
};