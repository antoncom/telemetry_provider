...
// "Timer Event" element implementation
import draw2d from '../_init_.js'
draw2d.bpmn.Timer = function () {
...
draw2d.bpmn.Timer.prototype = new draw2d.bpmn.Figure();
draw2d.bpmn.Timer.prototype.type = "bpmn.Timer";

draw2d.bpmn.Timer.prototype.createHTMLElement = function () {
	var $ = TeamTime.jQuery;
	...
	$(item).html(
		'<div class="bpmn_timer">\
			...
			<div class="bpmn_event_content">Timer</div>\
		</div>');
	$(".bpmn_icon", item).css("background-image", draw2d.bpmn.getCssImage("timer.png"));

	return item;
};

draw2d.bpmn.Timer.prototype.setWorkflow = function (/*:draw2d.Workflow*/ workflow) {
...
draw2d.bpmn.Timer.prototype.getContentElement = function () {
	var $ = TeamTime.jQuery;

	return $(".bpmn_event_content", this.html);
};

draw2d.bpmn.Timer.prototype.getContextMenuItems = function () {
	return {
		"delete": {
...
draw2d.bpmn.Timer.prototype.onContextMenuCmd = function (data) {
	if (data.key == "delete") {
