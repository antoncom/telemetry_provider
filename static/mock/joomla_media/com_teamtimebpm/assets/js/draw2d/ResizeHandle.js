...
draw2d.ResizeHandle=function(/*:draw2d.Workflow*/ workflow,  /*:int*/ type)
{
  ...
  switch(this.type)
  {
    ...
    case 9:
      this.setSnapToGridAnchor(new draw2d.Point(offset2,offset2));
      break;
  }
...
draw2d.ResizeHandle.prototype.onDragstart = function(/*:int*/ x, /*:int*/ y)
{
  ...
  this.commandMove  = figure.createCommand(new draw2d.EditPolicy(draw2d.EditPolicy.MOVE));
  this.commandResize= figure.createCommand(new draw2d.EditPolicy(draw2d.EditPolicy.RESIZE));
