...
draw2d.CommandAdd=function(/*:draw2d.Canvas*/ canvas, /*:draw2d.Figure*/ figure, /*:int*/x, /*:int*/y, /*:draw2d.CompartmentFigure*/ parent)
{
   draw2d.Command.call(this,"add figure");
   if(parent ===undefined)
      parent = null;

   this.parent   = parent; // draw2d.CompartmentFigure
   this.figure   = figure;
   this.x        = x;
   this.y        = y;
