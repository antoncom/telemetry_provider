...
draw2d.Figure.prototype.setWorkflow= function(/*:draw2d.Workflow*/ workflow)
{
	...
	if(this.draggable===null)
	{
		...
		this.draggable = new draw2d.Draggable(
			this.html, draw2d.Draggable.DRAG_X | draw2d.Draggable.DRAG_Y);
		...
		this.tmpMouseLeave  = function (oEvent){
			oThis.onMouseLeave();
		};
		this.tmpDragend     = function (oEvent){
			oThis.onDragend();
		};
		...
		this.tmpDrag        = function (oEvent){
			oThis.onDrag();
		};
		this.tmpDoubleClick = function (oEvent){
			oThis.onDoubleClick();
		};
