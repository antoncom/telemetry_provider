...
draw2d.Port=function(/*:draw2d.Figure*/ disconnectedUIRepresentation,/*:draw2d.Figure*/ connectedUIRepresentation)
{
  ...
  //
  if(disconnectedUIRepresentation===null || disconnectedUIRepresentation===undefined)
    this.currentUIRepresentation = new draw2d.Circle();
  else
    this.currentUIRepresentation = disconnectedUIRepresentation;


  if(connectedUIRepresentation===null  || connectedUIRepresentation===undefined)
  {
...
draw2d.Port.prototype.onDragend = function()
{
  ...
  // Note: very important line of code!!
  // You can't drag&drop an workflow object if you connect two ports via drag&drop
  // if you remove these line of code. You must click first into the document an 
  // then you can drag&drop the element on the canvas.
  document.body.focus();
};
 ...
 * @since 0.9.15
 **/
draw2d.Port.prototype.createCommand=function(/*:draw2d.EditPolicy*/ request)
{
