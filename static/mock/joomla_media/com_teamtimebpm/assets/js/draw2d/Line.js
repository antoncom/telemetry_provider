 ...
 **/
draw2d.Line.setDefaultCoronaWidth=function(/*:int*/ width)
{
 ...
 **/
draw2d.Line.prototype.setCoronaWidth=function(/*:int*/ width)
{
   this.corona = width;
};
 ...
 * @since 0.9.15
 **/
draw2d.Line.prototype.setId=function(/*:String*/ id)
{
  this.id=id;
  if(this.html!==null)
     this.html.id = id;
 ...
 * @type String
 **/
draw2d.Line.prototype.getProperty=function(/*:String*/ key)
{
 ...
 **/
draw2d.Line.prototype.setProperty=function(/*:String*/ key,/*:String*/ value)
{
 ...
 * Called by the framework. Don't call them manually.
 * @private
 * @param {draw2d.Workflow} workflow The new workflow canvas for this line (paint area)
 **/
 ...
 * @since 0.9.15
 **/
draw2d.Line.prototype.createCommand=function(/*:draw2d.EditPolicy*/ request)
{
 ...
 * @final
 */
draw2d.Line.prototype.setModel=function(/*:draw2d.AbstractObjectModel*/ model)
{
   if(this.model!==null)
...
/**
 * Callback method if the line has been remove from the Workflow object.<br>
 ...
 * @since 0.9.19
 **/
draw2d.Line.prototype.onRemove= function(/*:draw2d.Workflow*/ workflow)
{
};
 ...
 * @private
 **/
draw2d.Line.hit= function(/*:*/ coronaWidth, /*:int*/ X1, /*:int*/ Y1, /*:int*/ X2, /*:int*/ Y2, /*:int*/ px, /*:int*/ py)
{
