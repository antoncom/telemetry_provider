...
draw2d.VectorPropertyWindow.prototype.onSelectionChanged=function(/*:draw2d.Figure*/ figure)
{
  draw2d.PropertyWindow.prototype.onSelectionChanged.call(this,figure);
...
draw2d.VectorPropertyWindow.prototype.showLineColorDialog=function()
{
  ...
  var dialog = new draw2d.LineColorDialog(this.getCurrentSelection());
...
draw2d.VectorPropertyWindow.prototype.showFillColorDialog=function()
{
  ...
  var dialog = new draw2d.BackgroundColorDialog(this.getCurrentSelection());
